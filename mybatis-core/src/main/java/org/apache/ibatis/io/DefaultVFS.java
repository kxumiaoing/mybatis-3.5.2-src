...
public class DefaultVFS extends VFS {
   ...
   * url：包含path的所有URL
   * 获取以path为前缀的文件路径
   * url对应的如果是目录，就遍历该目录下面的所有子目录或者文件
   *
   * 难点：
   *  1、某些jbos VFS的实现，将不是jar的文件当成jar文件来处理
   *  2、某些文件系统支持像读取文件一样读取目录
   *  3、Weblogic的jar不一定在文件系统上
   */
